...
+function (a) {
    ...
    c.VERSION = "3.3.4", c.TRANSITION_DURATION = 150, c.prototype.show = function () {
        ...
        if (d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active")) {
            var e = c.find(".active:last a"), f = a.Event("http://cdn.bootcss.com/bootstrap/3.3.4/js/hide.bs.tab", {relatedTarget: b[0]}), g = a.Event("http://cdn.bootcss.com/bootstrap/3.3.4/js/show.bs.tab", {relatedTarget: e[0]});
            if (e.trigger(f), b.trigger(g), !g.isDefaultPrevented() && !f.isDefaultPrevented()) {
                var h = a(d);
                this.activate(b.closest("li"), c), this.activate(h, h.parent(), function () {
                    e.trigger({type: "http://cdn.bootcss.com/bootstrap/3.3.4/js/hidden.bs.tab", relatedTarget: b[0]}), b.trigger({type: "http://cdn.bootcss.com/bootstrap/3.3.4/js/shown.bs.tab", relatedTarget: e[0]})
                })
            }
        }
